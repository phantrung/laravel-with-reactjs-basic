...
const FormField = props => {
    ...
    return (
        <div className={clsx('form-field-group my-4',className)}>
            {label && <label className="field-label mb-1 inline-block" htmlFor="name">{label} {required && <span className="field-required text-red-700">*</span>}</label>}
            {field}
